...
% ----- Range di angoli -----
step = 2;  % più piccolo = più preciso, ma più lento
alpha_range = 0:step:180;
beta_range  = 0:step:180;
gamma_range = 0:step:180;

% ----- File di output -----
outfile = 'angoli_validi_step2_from0_to180_B_1_5.txt';
fid = fopen(outfile, 'w');
...
% ----- Range di angoli -----
step = 5;  % più piccolo = più preciso, ma più lento
alpha_range = 0:step:180;
beta_range  = 0:step:180;
gamma_range = 0:step:180;

% ----- File di output -----
outfile = 'angoli_validi_step5_from0_to180_B_1_5.txt';
fid = fopen(outfile, 'w');
fprintf(fid, 'alpha_deg\tbeta_deg\tgamma_deg\tsse\tsum_diff\n');
...
% ----- Parametri selezione deep -----
threshold = -0.1;   % intensità minima (ips)
dminGHz   = 0.002;  % distanza minima tra deep in GHz
promMin   = 0.02;   % prominenza minima (unità di ips normalizzato)
winGHz    = 0.02;   % finestra per prominenza nel fallback manuale
