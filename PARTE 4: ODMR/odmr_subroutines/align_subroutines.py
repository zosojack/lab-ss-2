...
def intensità_e_frequenze_sweep (time, ch_A, ch_B, index):
...
def leggi_files (reference: str, odmr: str, index, mean):
    ...
    frequenze, intensità_ref = intensità_e_frequenze_sweep(time_ref, ch_A_ref, ch_B_ref, index)
